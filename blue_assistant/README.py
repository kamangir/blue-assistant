...
items = README.Items(
    [
        ...
        },
        {
            ...
            "description": '"[Hey AI](./blue_assistant/script/repository/hue/metadata.yaml), help me send color commands to the [Hue LED lights](https://www.philips-hue.com/en-ca) in my apartment."',
        },
        {
            "name": "blue-amo",
